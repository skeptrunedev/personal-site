...
If you want the raw data, you can find it on the [GitHub repository](https://github.com/skeptrunedev/personal-site/tree/main/src/assets/data/blog-posts/JukeboxAnalysis/dev.sqlite3).
