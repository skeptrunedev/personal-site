---
title: "Making Palmer Luckey and Paul Graham perform Hotel Lobby"
...
coverImageAlt: "AI character edit with Palmer Luckey on the left and Paul Graham on the right, with their shorts and sandals visible"
...
The important checks are the faces, the left and right assignments, the clothes and the original performance. I also asked for no jewelry on either person.
...
<Figure image={generatedWide} alt="Generated comparison frame for Palmer on the left and Paul on the right" caption="Compare this generated frame with the source at the same timestamp, including the full outfits and footwear." />
...
For X, export a 1440 × 1080 H264 MP4, keeping the 4:3 frame and copying the audio from the trimmed source. Check the actual generated dimensions and duration before exporting.
