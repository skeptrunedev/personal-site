...
updatedAt: 2026-09-22T00:56:30-07:00
...
I wanted Palmer Luckey and Paul Graham to perform Hotel Lobby, with Palmer on the left and Paul on the right. Palmer had to be in a Hawaiian shirt, shorts and flip flops. Paul had to be wearing his polo, cargo shorts and sandals. The movement, camera cuts and orange studio should come from the original performance.
...
Here is the result. Palmer's outfit and the left and right assignments carried through. The model still kept rings and Paul's watch, and missed Paul's cargo pockets. Those misses are visible below too.
