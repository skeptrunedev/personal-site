...
coverImage: src/assets/images/blog-posts/XGBoostIsAllYouNeed/cover.jpeg
...
Want to see the full implementation? Check out the [complete Jupyter notebook walkthrough](https://github.com/skeptrunedev/personal-site/blob/main/data-analysis/xgboost-nfl-rb.ipynb) with all the code, data processing steps, training, and visualizations.
