...
coverImage: src/assets/images/blog-posts/InferenceEngineeringSkillsMap/open-graph.png
coverImageAlt: "Inference Engineering 101 diagram with three branches: coordinate the work with Dynamo and llm-d, run the model with vLLM and SGLang, and reuse previous work with HiCache, LMCache and Mooncake"
isDraft: false
isFeatured: true
