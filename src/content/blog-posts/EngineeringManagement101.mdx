...
Occasionally I see a project where no code goes out to production for an entire day. In these specific cases I _always_ will jump in and get some work over the finish line. Or it can be gigantic issues in the issue tracker that need to be broken down. I'll just go in and break them down myself. You have to parachute in sometimes.
